...
class AppColors {
  ...
  static final Color mainColor = const Color(0xFF004580);
  static final Color mainColor2 = const Color(0xFF2E7D32);
  // static final Color mainColor2 = const Color(0xFF2E7D32);
  static final Color iconColor1 = const Color(0xFFffd28d);
  static final Color iconColor2 = const Color(0xFFfcab88);
  static final Color pacaColor = const Color(0xFF8f837f);
...
//static final Color yellowColor = const Color(OxFFfa7552);
